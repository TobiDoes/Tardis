...
public class TardisRoundelOpenBlock extends TheCubedGallifreyanModElements.ModElement {
	@ObjectHolder("the_cubed_gallifreyan:tardis_roundel_open")
	public static final Block block = null;
	public TardisRoundelOpenBlock(TheCubedGallifreyanModElements instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tardis_roundel_open");
		}
